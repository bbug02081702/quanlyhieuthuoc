...
class PurchaseController extends Controller
{
        ...
        if($request->ajax()){
            ...
            return DataTables::of($purchases)
                ...
                ->addColumn('cost_price',function($purchase){
                    return settings('app_currency','đ'). ' '. $purchase->cost_price;
                })
    ...
    public function store(Request $request)
    {
        ...
        $notifications = notify("Nhập thuốc đã được thêm vào");
    ...
    public function update(Request $request, Purchase $purchase)
    {
        ...
        $notifications = notify("Nhập thuốc đã được cập nhật");
        return redirect()->route('purchases.index')->with($notifications);
    }
