...
class UserController extends Controller
{
    ...
    public function update(Request $request, User $user)
    {
        ...
        $user->assignRole($request->role);
        $notification = notify('người dùng đã cập nhật thành công');
    ...
    public function updateProfile(Request $request,User $user){
        ...
        $notification = notify('Hồ sơ được cập nhật thành công');
    ...
    public function updatePassword(Request $request, User $user)
    {
        ...
        if ($verify_password) {
            ...
            $notification = notify('Mật khẩu người dùng được cập nhật thành công!!!');
            $logout = auth()->logout();
            return back()->with($notification, $logout);
        } elseif(!$verify_password) {
            $notification = notify("Mật khẩu cũ không chính xác!!!",'danger');
