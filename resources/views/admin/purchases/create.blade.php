...
@push('page-header')
<div class="col-sm-12">
	<h3 class="page-title">Thêm thuốc nhập</h3>
	<ul class="breadcrumb">
		<li class="breadcrumb-item"><a href="{{route('dashboard')}}">Bảng điều khiển</a></li>
		<li class="breadcrumb-item active">Thêm thuốc nhập</li>
	</ul>
</div>
@endpush
			...
			<div class="card-body custom-edit-service">
				...
				<form method="post" enctype="multipart/form-data" autocomplete="off" action="{{route('purchases.store')}}">
					...
					<div class="submit-section">
						<button class="btn btn-success submit-btn" type="submit" >Đồng ý</button>
					</div>
				</form>
				<!-- /Add thuoc -->
			</div>
